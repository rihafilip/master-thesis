...
\newcommand{\exportdrawio}[3]{
  \filemodCmp{#1}{#3}{
    ...
    % \immediate\write18{drawio #1 --output #3 --page-index #2 --export --crop}
  }{}
}

% Arguments - [includegraphics options], page index
% \newcommand{\includediagram}[2][]{
%   \exportdrawio{diagrams/diagrams.drawio}{#2}{diagrams/diagram-#2.pdf}
%   \includegraphics[#1]{diagrams/diagram-#2.pdf}
% }
