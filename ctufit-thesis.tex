...
\newcommand{\todoo}[1]{\todo[linecolor=red,backgroundcolor=red!25,bordercolor=red]{#1}}
\newcommand{\todoi}[1]{\todo[linecolor=red,backgroundcolor=red!25,bordercolor=red,inline]{#1}}
\newcommand{\makesure}[1]{\todo[linecolor=green,backgroundcolor=green!25,bordercolor=green,inline]{#1}}
\newcommand{\todocite}[0]{[\textbf{?}]}
...
\begin{declarationpage}
    \makesure{is this the correct declaration (should be for GPL)}
...
\include{text/1_r_language}
\include{text/2_feedback_pollution}
\include{text/3_recording_tool}
\include{text/4_assesment}
\include{text/5_related_work}
